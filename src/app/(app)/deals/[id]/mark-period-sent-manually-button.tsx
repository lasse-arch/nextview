  ...
  return (
    <div className="relative inline-block">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex w-28 items-center justify-center rounded-md border border-slate-300 px-2.5 py-1.5 text-center text-xs font-medium text-slate-600 hover:bg-slate-50"
      >
